...
function getIconGlyph(iconElement, index) {
  if (iconElement) {
...
function parse4(element, { document }) {
  ...
  slides.forEach((slide) => {
    ...
    const heading = slide.querySelector(".jlr-hero-slider-banner__copy h1") || slide.querySelector(".jlr-hero-slider-banner__copy h2") || slide.querySelector(".jlr-hero-slider-banner__copy h3") || slide.querySelector(".jlr-hero-slider-banner h1, .jlr-hero-slider-banner h2") || slide.querySelector(".jlr-copy-box__heading") || slide.querySelector(".jlr-hero-carousel-slide-core__banner h1, .jlr-hero-carousel-slide-core__banner h2, .jlr-hero-carousel-slide-core__banner h3");
    const desc = slide.querySelector(".jlr-hero-slider-banner__copy .jlr-paragraph") || slide.querySelector('.jlr-hero-slider-banner__copy div[class*="paragraph"]') || slide.querySelector(".jlr-copy-box__paragraph") || slide.querySelector(".jlr-hero-carousel-slide-core__banner .jlr-paragraph");
    const imageCell = [];
    if (img) {
...
function parse7(element, { document }) {
  ...
  if (slidesAttr) {
    try {
      carouselSlideData = JSON.parse(slidesAttr);
    } catch (e) {
    }
  }
...
function transform2(main, document, url) {
  ...
  for (let i = 0; i < renderBlocks.length; i++) {
    ...
    if (blockType === "tab-nav") {
      const boAttr = renderBlock.getAttribute("data-model-selector") || section.getAttribute("data-model-selector");
      if (boAttr) {
        try {
